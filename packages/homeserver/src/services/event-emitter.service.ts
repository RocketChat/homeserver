import { Emitter, type EventHandlerOf, type EventOf } from '@rocket.chat/emitter';
...
export class EventEmitterService {
	private emitter: Emitter<HomeserverEventSignatures> = new Emitter<HomeserverEventSignatures>();
