// v3 changes event schema, therefore so does how we validate events, sort of
//
...
): PduPowerLevelsEventV3 | undefined {
	return (
		event && {
			...event,
			...{
...
function isCreateAllowed(event: PduCreateEventV3) {
