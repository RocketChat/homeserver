...
const finalEvent = {
    auth_events: [ "$zHsjo62uA3WT_8ZGvr53LIUxPOTbJ-MKPu2JsA6eGdw", "$mockedPowerLevelsEventId", "$iyTj_L9HN1LNr2wjiHLz6Q7-HVjrKnCWyvwEM2yl6gE"],
    ...
    signatures: {
      rc1: {
        "ed25519:a_HDhg": "i3Fl5Iq3KimM/AsZuhfiN1iBln1cY7EUmOhVyfRfrrEZkzhuOilwOVsWiWS8bmwqtgIOa7A8EFuTr6BoHklLBQ",
      },
    },
  }
