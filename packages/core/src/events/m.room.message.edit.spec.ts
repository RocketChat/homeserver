...
const finalEvent = {
    ...
    "prev_events": [
        "$Ba7sNv7Qg9-u-1mj7aOAtncgN8oGpmhfK8mHc_bBFHY"
    ],
    "type": "m.room.message",
    ...
    "signatures": {
        "rc1": {
            "ed25519:a_HDhg": "SCxkiAspRbWE7COF9IncV1eGiJPSb4iwLQi90rijpCXj8iALXTS6M4uVljpEzRgyz6Xa9UZ6ea+kguDFrbxKDA"
        }
    }
};
...
test("formatted content editing", async () => {
    ...
    const signedOriginalMessage = await signEvent(originalMessage, signature, "rc1");
