...
export function pruneEventDict(eventDict: {
    type: "m.room.member" | "m.room.create" | "m.room.join_rules" | "m.room.power_levels" | "m.room.aliases" | "m.room.history_visibility" | "m.room.redaction" | string;
    [key: string]: any;
    ...
    if (eventType === "m.room.member") {
        ...
        const contentKeys = [
            ...
            ...(eventType === "m.room.member") && roomVersion.restricted_join_rule_fix ? ["authorising_user"] : []
        ];
